...
<div class="right">
    ...
    <div class="column" onclick="document.location='go_myorder.do?uid=${userEntity.u_id}';">
    ...
    <div class="column"  onclick="document.location='go_address.do?uid=${userEntity.u_id}';">
